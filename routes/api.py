...
#     })
# @api.route('/api/schedules/<user_id>')
# @login_required
# def get_schedules(user_id):
#     """사용자 일정 조회"""
#     try:
#         # 현재 로그인한 사용자만 자신의 일정 조회 가능
#         if current_user.username != user_id:
#             return jsonify({'error': 'Unauthorized'}), 403
        
#         schedules = SimpleSchedule.query.filter_by(user_id=user_id).all()
...
#     """일정 삭제"""
#     try:
#         schedule = SimpleSchedule.query.get_or_404(schedule_id)
